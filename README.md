...
- [3.模块化、对象和状态](3)
  - [3.1 赋值和局部状态](3/1)
    - [3.1.1 局部状态变量](3/1/1)
      ...
      - [练习 3.5](3/1/1/solution.3.5.rkt)
      - [练习 3.6](3/1/1/solution.3.6.rkt)
    - [3.1.3 引进赋值的代价](3/1/3)
      - [练习 3.7](3/1/3/solution.3.7.rkt)
      - [练习 3.8](3/1/3/solution.3.8.rkt) :star:
  - [3.3 用变动数据做模拟](3/3)
    - [3.3.1 变动的表结构](3/3/1)
      - [练习 3.16](3/3/1/solution.3.16.rkt)
      - [练习 3.17](3/3/1/solution.3.17.rkt) :star:
      - [练习 3.18](3/3/1/solution.3.18.rkt)
      - [练习 3.19](3/3/1/solution.3.19.rkt)
    - [3.3.2 变动的表结构](3/3/2)
      - [练习 3.21](3/3/2/solution.3.21.rkt)
      - [练习 3.22](3/3/2/solution.3.22.rkt)
      - [练习 3.23](3/3/2/solution.3.23.rkt) :star:
    - [3.3.3 表格的表示](3/3/3)
      - [练习 3.24](3/3/3/solution.3.24.rkt)
      - [练习 3.25](3/3/3/solution.3.25.rkt)
      - [练习 3.26](3/3/3/solution.3.26.rkt) :star:
      - [练习 3.27](3/3/3/solution.3.27.rkt) :star:
    - [3.3.4 数字电路的模拟器](3/3/4)
  - [3.4 并发：时间是一个本质问题](3/4)
    - [3.4.2 控制并发的机制](3/4/2)
      - [练习 3.47](3/4/2/solution.3.47.rkt) :star:
  - [3.5 流](3/5)
    - [3.5.1 流作为延时的表](3/5/1)
      - [练习 3.51](3/5/1/solution.3.51.rkt) :star:
- [4.元语言抽象](4)
- [5.寄存器机器里的计算](5)
